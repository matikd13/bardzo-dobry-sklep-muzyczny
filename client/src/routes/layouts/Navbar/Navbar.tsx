    ...
    <>
      <Box className="inset-x-0 top-0 bg-blue-950 px-10 py-8 text-blue-50" sx={{ width: '100%' }}>
        <Grid container direction="row" alignItems="center" justifyContent="space-evenly">
          ...
          <Grid>
            <Button component={Link} to="/search" className="bg-sky-500" variant="contained" size="large">
              Szukaj
            </Button>
          </Grid>
          ...
          <Grid>
            <Button component={Link} to="/cart" className="bg-sky-500" variant="contained" size="large">
              Koszyk
            </Button>
          </Grid>
        </Grid>
